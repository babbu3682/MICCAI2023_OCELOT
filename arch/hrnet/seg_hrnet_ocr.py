...
# https://github.com/HRNet/HRNet-Semantic-Segmentation/blob/HRNet-OCR/experiments/ade20k/seg_hrnet_ocr_w48_520x520_ohem_sgd_lr2e-2_wd1e-4_bs_16_epoch120.yaml
# https://github.com/HRNet/HRNet-Semantic-Segmentation/blob/0bbb2880446ddff2d78f8dd7e8c4c610151d5a51/lib/config/default.py#L44
...
class HighResolutionNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out_aux = F.interpolate(input=out_aux, size=(512, 512), mode='bilinear', align_corners=True)
        out     = F.interpolate(input=out,     size=(512, 512), mode='bilinear', align_corners=True)
    ...
    def init_weights(self, pretrained='',):
        ...
        if os.path.isfile(pretrained):
            ...
            # pretrained_dict 중에 cls_head, aux_head 빼기
            pretrained_dict = {k: v for k, v in pretrained_dict.items() if 'cls_head' not in k and 'aux_head' not in k}
